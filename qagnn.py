...
def evaluate_accuracy(eval_set, model):
    ...
    pro_f1 = f1_score(y_label,y_pred,labels=[1],average="macro")
    con_f1 = f1_score(y_label,y_pred,labels=[0],average="macro")
    neu_f1 = f1_score(y_label,y_pred,labels=[2],average="macro")
    f1_ma = f1_score(y_label,y_pred,labels=list(range(3)),average="macro")
    return n_correct / n_samples, pro_f1, con_f1, neu_f1, f1_ma
...
def train(args):
    ...
    with open(log_path, 'w') as fout:
        fout.write('step,dev_acc,test_acc,test_pro_f1, test_con_f1, test_neu_f1, test_f1_ma\n')
    ...
    best_dev_f1_ma, final_test_acc, total_loss = 0.0, 0.0, 0.0
    ...
    # try:
        for epoch_id in range(args.n_epochs):
            ...
            if not save_test_preds:
                test_acc, test_pro_f1, test_con_f1, test_neu_f1, test_f1_ma = evaluate_accuracy(dataset.test(), model) if args.test_statements else 0.0
            else:
                ...
                test_pro_f1 = f1_score(y_label,y_pred,labels=[1],average="macro")
            ...
            print('-' * 71)
            print('| epoch {:3} | step {:5} | dev_acc {:7.4f} | test_acc {:7.4f} | test_pro_f1 {:7.4f} | test_con_f1 {:7.4f} | test_neu_f1 {:7.4f} | test_ma_f1 {:7.4f} |'.format(epoch_id, global_step, dev_acc, test_acc, test_pro_f1, test_con_f1, test_neu_f1, test_f1_ma))
            print('-' * 71)
            with open(log_path, 'a') as fout:
                fout.write('{},{},{},{},{},{},{}\n'.format(global_step, dev_acc, test_acc, test_pro_f1, test_con_f1, test_neu_f1, test_f1_ma))
            if dev_f1_ma >= best_dev_f1_ma:
                best_dev_f1_ma = dev_f1_ma
