...
def main():
    ...
    routines = {
        ...
        'vast_zero': [
            ...
            {'func': generate_adj_data_from_grounded_concepts__use_LM, 'args': (output_paths['vast_zero']['grounded']['train_4'], output_paths['cpnet']['pruned-graph'], output_paths['cpnet']['vocab'], output_paths['vast_zero']['graph']['adj-train_4'], args.nprocs)},
