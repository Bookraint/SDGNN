...
input_paths = {
    ...
    'vast_all': {
        ...
        'dev': './data/vast_all/vast_dev.csv',
        'test': './data/vast_all/vast_test.csv',
    },
    'csqa': {
...
def main():
    ...
    parser.add_argument('--run', default=['vast_few'], choices=['common', 'csqa', 'hswag', 'anli', 'exp', 'scitail', 'phys', 'socialiqa', 'obqa', 'obqa-fact', 'make_word_vocab'], nargs='+')
